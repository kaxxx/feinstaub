...
import serial, struct, sys, time, json, subprocess, requests
...
def restkodi(ppm10,ppm25):
    headers = {
        'Content-Type': 'application/json',
    }
    data = '{"jsonrpc": "2.0","method": "GUI.ShowNotification","params":{"title": "FEINSTAUB","message": "ppm10:'+str(ppm10)+' - ppm25:'+str(ppm25)+' (µg/m³)"}}'
    try:
       response = requests.post('http://osmc-kueche:8080/jsonrpc', headers=headers, data=data)
       print(response)
    except:
